...
router.get('/contacts/', query('id').notEmpty(), requestValidator, sessionValidator, controller.get_Contacts)
router.get('/getmessages/:jid', query('id').notEmpty(), requestValidator, sessionValidator, getMessages)

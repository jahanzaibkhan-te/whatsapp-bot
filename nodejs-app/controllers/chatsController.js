import { getSession,getContacts, getChatList, isExists, sendMessage, formatPhone } from './../whatsapp.js'
import response from './../response.js'

const getList = (req, res) => {
    var resp = response(res, 200, true, '', getChatList(res.locals.sessionId))
    return resp ;
}
const get_Contacts = (req, res) => {
    var resp = response(res, 200, true, '', getContacts(res.locals.sessionId))
    return resp ;
}
...
export { getList, send, sendBulk,get_Contacts }
